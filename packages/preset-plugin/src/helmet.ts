...
export default api => {
  ...
  const helmetPkgPath = winPath(dirname(require.resolve('react-helmet-async/package')));
  ...
  api.onGenerateFiles(async () => {
    api.writeTmpFile({
      path: 'index.ts',
      content: Mustache.render(`export { Helmet, HelmetProvider, HelmetData } from '{{{ HelmetPkg }}}';`, {
